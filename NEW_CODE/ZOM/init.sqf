...
*/
	...
	zRLogic = 1; // If set to 1 it uses Ryans mod logic if he updates it else uses damage code in bottom generate_zone file
	zombiedamage = 15; // Not used if using zRLogic
	ZOMdistancepop = 400; //distance trigger pops lower it for better FPS smaller zone = less zeds
